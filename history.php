...
<h2>
            <img src="logos/tt1.png" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Transaction History</strong> <img
                src="logos/tt2.jpg" alt="Bank" width="75" height="75">
        </h2>
        </head>
...
<div class="d-grip gap-2 col-6 mx-auto text-center p-3 mb-2">
    <a href="money.php"><button type="button" class="btn btn-warning btn-lg mb-3" style = "border-radius:20px">Click  to Transfer Money</button></a>
</div>
...
<!-- Table -->
    ...
    <table class="table table-hover table-striped">
        <thead style="color : black; background-color:green;">
            <tr>
